-- ============================================================
-- EverDream — Consolidated Database Schema (Migration 001)
-- Combines all previous migrations into a single idempotent script
-- Creates: profiles, dreams, sleep_sessions, user_settings, nfts, dream_assets, sync_log, webhook_events
